...
class ScatterGatherAllFailPartialTest {
        ...
        RoutingConfiguration routing() {
            return RoutingConfiguration.builder()
                    .addScatterRoute(new ScatterRoute("/scatter-allfail")
                            .addLeg(new Leg(Origin.of("bad1", "http://localhost:19999/nope1"))
                                    .setMethod(HttpMethod.GET))
                            .addLeg(new Leg(Origin.of("bad2", "http://localhost:19998/nope2"))
                                    .setMethod(HttpMethod.GET))
    ...
    @Test
    void test_allFail_partial_composer_returns_fallback() {
        RestAssured.given()
                .get("/scatter-allfail")
                .then()
